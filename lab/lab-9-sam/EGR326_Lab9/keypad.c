...
uint8_t xkeypad_ReadKeypad(void)
{
    ...
    if (col==3) return 0;
    if (row==0x0e)  keypad_keyPressed = 48+col+1;         //1-3
    if (row==0x0d)  keypad_keyPressed = 51+col+1;         //4-6
    if (row==0x0b)  keypad_keyPressed = 54+col+1;         //7-9
    if (row==0x07)  keypad_keyPressed = 57+col+1;         //10-12
